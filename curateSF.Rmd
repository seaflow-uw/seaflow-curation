---
title: "SeaFlow Curation Notebook"
output: 
  html_document:
    toc: true
params:
...
# TODO: fix this for multiple filtering parameters
# Just use the first param for now
...
if (!is.na(curate$tcut1)) { # applies to only a few cruises
  ...
  # Report percentage of data removed as outliers in this step
